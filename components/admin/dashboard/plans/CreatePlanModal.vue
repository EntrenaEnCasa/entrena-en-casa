            ...
            <CommonModal ref="modal">
                ...
                <div>
                    ...
                    <div class="flex justify-center gap-4 mt-5">
                        ...
                        <CommonButton @click="createPlan" bg-color="primary"
                            class="px-4 py-2 rounded-lg text-white font-medium outline">Crear plan
                        </CommonButton>
                    </div>
                </div>
            </CommonModal>
...
const createPlan = async () => {
    ...
    const plan = {
        ...
        expiration_time: Number(newPlan.value.expiration_time),

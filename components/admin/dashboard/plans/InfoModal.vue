            ...
            <CommonModal ref="modal">
                ...
                <div v-else>
                    ...
                    <form v-if="newPlan" class="grid gap-5 ">
                        <div class="grid grid-cols-3 gap-10 items-center">
                            ...
                            <div class=" flex items-center  col-span-2 space-x-2">
                                <CommonInput type=" text" class=" text-left" name="quantity"
                        ...
                        <div class="grid grid-cols-3 gap-10 items-center">
                            ...
                            <CommonSelect v-model="newPlan.credit_type" name="tipo" id="tipo"
                                :options="creditTypeOptions" />
                        </div>
                        <div class="grid grid-cols-3 gap-10 items-center">
                            <label class=" col-span-1 text-right" for="">Formato</label>
                            <CommonSelect v-model="newPlan.format_credit" name="format" id="format"
                                :options="formatOptions" />
                        </div>
                        <div class="grid grid-cols-3 gap-10 items-center">
                            <label class=" col-span-1 text-right" for="">Expiración</label>
                            <div class=" flex items-center  col-span-2 space-x-2">
                                <CommonInput type=" text" name="expiration" class=" text-left"
                        ...
                        <div class="grid grid-cols-3 gap-10 items-center">
                            ...
                            <div class=" flex items-center  col-span-2 space-x-2">
                                ...
                                <CommonInput type=" text" class=" text-left" name=price v-model="newPlan.price" />
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-10 items-center pb-5">
                            <label class=" col-span-1 text-right" for="">Descripción</label>
                            <CommonTextarea type=" text" name="description" class=" w-4/5 h-12 col-span-2"
                        ...
                        <div class="grid grid-cols-3 gap-10 items-start pb-5">
                            ...
                            <div class="col-span-2 grid gap-2">
                                <CommonSelect aria-multiselectable="true" v-model="selectedRegion" name="region"
                                    id="region" :options="regionOptions" @change="handleRegionChange" />
                                <div v-for="     chip      in      chipsRegion     " class="flex items-center">
                                    <span
                                        ...
                                        <Icon @click="removeChip(chip)" class="text-lg mr-2 my-auto "
                    ...
                    <div class="flex justify-between gap-4 mt-5">
                        <CommonButton @click="openModalDeletePlan" bg-color="tertiary"
                            class="px-4 py-2 rounded-lg text-white font-medium outline">Borrar plan</CommonButton>
                        <CommonButton @click="updatePlan" bg-color="primary"
                            class="px-4 py-2 rounded-lg text-white font-medium outline">Modificar plan
                        </CommonButton>
                    </div>
                </div>
            </CommonModal>

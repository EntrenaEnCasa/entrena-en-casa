        ...
        <Teleport to="body">
            <CommonModal ref="modal">
                <div class="w-full ">
                    ...
                    <div class="w-full px-8">
                        ...
                        <div class="overflow-x-auto ">
                            <table  class="bg-white table-auto text-sm text-left text-gray-500 mb-7">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b " v-for="credit in plans" >
                                        <td class="px-6 py-4 whitespace-nowrap ">
                                            <div  v-if="credit.credit_type === 'PP' && credit.format_credit === 'Dupla'">
                                    ...
                                    <Icon name="mdi:weight-lifter" class="text-3xl" />
                                            ...
                                            <div v-else-if="credit.credit_type === 'PP' && credit.format_credit === 'Individual'">
                                                <div class="text-secondary whitespace-nowrap">
                                ...
                                <div v-else-if="credit.credit_type === 'PO' && credit.format_credit === 'Dupla'">
                                    <div class="text-secondary whitespace-nowrap">
                                ...
                                <div v-else-if="credit.credit_type === 'PO' && credit.format_credit === 'Individual'">
                                    <div class="text-secondary whitespace-nowrap">
                                    <Icon name="ion:person" class="text-2xl" />
                                    <Icon name="material-symbols:laptop-mac-outline" class="text-3xl" />
                                </div>
                                ...
                                <div v-else-if="credit.credit_type === 'GO' ">
                                    ...
                                    <Icon name="material-symbols:laptop-mac-outline" class="text-3xl" />
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap ">
                                           {{ credit.available_credits}} / {{ credit.available_credits + credit.used_credits }} sesiones
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap ">
                    ...
                    <AdminDashboardModifyPlanModal ref="modifyPlan" :student="student" :plan="planToModify" />
                    <AdminDashboardAddPlanModal ref="addPlan" :student="student" />
                    </div>
</template>

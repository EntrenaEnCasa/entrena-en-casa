<template>
    <div style="margin-top: 60px; margin-bottom: 60px">
        <div class="container d-flex flex-column align-items-center justify-content-center">
            <p class="fs-7" style="letter-spacing: .15rem;">CONTACTO</p>
            <h2 class="fw-medium fs-1">¿Tienes dudas? ¡Contactanos!</h2>
            <div class="d-flex gap-4 mt-3">
                <div class="fs-4 d-flex align-items-center gap-2" style="color: #0EB3E0">
                    <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                        <rect x="48" y="96" width="416" height="320" rx="40" ry="40" fill="none" stroke="currentColor"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                        <path fill="none" stroke="#0EB3E0" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"

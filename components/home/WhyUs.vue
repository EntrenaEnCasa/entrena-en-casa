<template>
    <div class="my-5">
        <div class="text-center w-11/12 mx-auto">
            ...
            <p class="font-light">
                Entrena en Casa es la nueva forma de ejercitarse y vivir de
                forma más saludable.
            </p>
        </div>
                ...
                <ul class="text-start space-y-2 flex flex-col items-center">
                    <li class="flex w-3/4 items-center">
                        <Icon
                            ...
                            class="text-secondary text-4xl mr-2" />
                        <p class="font-light">
                            Entrena sin tener que moverte de tu hogar, no
                            pierdas tiempo.
                        </p>
                    </li>
                    <li class="flex w-3/4 items-center">
                        ...
                        <p class="font-light">
                            Ahorras dinero en combustible y en planes de
                            gimnasio que no asistes.
                        </p>
                    </li>
                    <li class="flex w-3/4 items-center">
                        <Icon
                            ...
                            class="text-secondary text-4xl mr-2" />
                        <p class="font-light">
                            Sé el propio dueño de tu tiempo, la hora de entrenar
                            la defines tú.
                        </p>
                    </li>
                    <li class="flex w-3/4 items-center">
                        <Icon
                            ...
                            class="text-primary text-4xl mr-2" />
                        <p class="font-light">
                            Asesoramiento integral: Coaching, actividad física y
                            nutrición.
                        </p>
                    </li>
                </ul>

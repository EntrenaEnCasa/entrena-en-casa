<template>
    <div class="bg-gradiente py-10 lg:pt-32 lg:pb-20">
        <div class="grid grid-cols-1 lg:grid-cols-3 w-11/12 mx-auto">
            <div class="order-last lg:order-none col-span-2">
                <div class="flex flex-col gap-8 w-11/12 mx-auto">
                    <div class="px-6 py-4 border mx-auto bg-white relative w-full">
                        ...
                        <div
                            class="flex justify-center mt-4 md:mt-0 md:absolute md:-top-4 md:-right-8">
                            <span
                                class="text-white text-3xl font-semibold py-2 px-4 tellural rounded-lg bg-secondary">
                                $20.000
                            </span>
                        </div>
                    </div>
            ...
            <div
                class="col-span-1 flex flex-col justify-center items-center space-y-2 mb-10 lg:mb-0">

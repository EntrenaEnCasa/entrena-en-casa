<template>
    <aside
        id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-72 h-screen pt-24 duration-300 transition-transform -translate-x-full bg-white border-r border-gray-200 lg:translate-x-0"

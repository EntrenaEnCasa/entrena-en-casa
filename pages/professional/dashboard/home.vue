...
const { formatDateToFullLongFormat } = useFormatter();
...
const {
    ...
    pending: currentSessionLoading,
    error: currentSessionError,
    refresh: getCurrentSession,
} = await useFetch<currentSessionResponse>(
    `${config.public.apiBase}/professional/session/attendance/${userStore.user?.user_id}`,
    {
        method: "GET",
        credentials: "include",
        lazy: true,
...
const updateStudentInfo = async () => {
    ...
    try {
        const response = await $fetch<updateStudentInfoResponse>(
            `${config.public.apiBase}/professional/student/update`,
            {
                method: "PUT",
                credentials: "include",
                body: body,

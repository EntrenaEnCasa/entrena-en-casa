    ...
    <div class="space-y-4 min-h-[calc(100vh_-_5rem)] flex items-center justify-center">
        <div class="text-center max-w-2xl mx-auto">
            ...
            <div v-else-if="error" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="inline-flex flex-col lg:flex-row gap-2">
                        <CommonButton @click="() => $router.push('/email/verify-email')" bg-color="secondary"
                            class="px-4 py-2">
            ...
            <div v-else-if="response.success" class="space-y-5">
                ...
                <div>
                    <CommonButton @click="() => $router.push('/user/dashboard/home')" bg-color="primary"
                        class="px-4 py-2">
                        Ir a inicio
                    </CommonButton>
                </div>
            ...
            <div v-else class="space-y-5">
                ...
                <div>
                    ...
                    <div class="inline-flex gap-3">
                        <CommonButton @click="() => $router.push('/user/dashboard/home')" bg-color="zinc-500"
                            class="px-4 py-2">
                            Ir a inicio
                        </CommonButton>
                        <CommonButton @click="() => $router.push('/email/verify-email')" bg-color="secondary"
...
const { data: response, pending: loading, error } = await useFetch(`/api/auth/verify-email`, {
    method: 'POST',
    body: {

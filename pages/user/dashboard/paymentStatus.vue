<template>
    <div class="space-y-4">
        ...
        <div
            v-else-if="data"
            class="flex justify-center text-center max-w-2xl mx-auto">
            <div v-if="data.response.status == 1" class="space-y-5">
                ...
                <div class="inline-flex bg-yellow-50 p-12 rounded-full">
                    <Icon
                        ...
                        class="text-yellow-500 text-9xl" />
                </div>
                <div>
                    <p class="mb-4">
                        Puedes volver a intentar comprar un plan en la página de
                        créditos.
                    </p>
                    <CommonButton
            ...
            <div v-else-if="data.response.status == 2" class="space-y-5">
                ...
                <div>
                    <p class="mb-4">
                        Se cargará a tu cuenta el plan contratado, puedes
                        revisarlo en la página de créditos.
                    </p>
                    <CommonButton
                        @click="() => $router.push('/user/dashboard/credits')"
                        bg-color="primary"
            ...
            <div
                v-else-if="
                    data.response.status == 3 || data.response.status == 4
                "
                class="space-y-5">
                <div>
                    <h3 class="font-bold text-4xl mb-2">¡Oops!</h3>
                    <p>
                        El pago no ha concluido correctamente o se ha
                        sobrepasado el tiempo de espera para efectuar
                        transacción.
                    </p>
                </div>
                ...
                <div>
                    <p class="mb-4">
                        Puedes volver a intentar comprar un plan en la página de
                        créditos, o si así lo deseas, también puedes consultar
                        por ayuda a nuestro jefe de servicio al cliente, Jorge.
                    </p>
